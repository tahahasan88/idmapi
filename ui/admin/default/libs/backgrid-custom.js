...
(function (root, factory) {
    ...
    */
    ...
    _.assignIn(Backgrid, Backbone.Events);
    ...
    */
    ...
    _.assignIn(CellFormatter.prototype, {
    ...
    */
    var NumberFormatter = Backgrid.NumberFormatter = function (options) {
      _.assignIn(this, this.defaults, options || {});
    ...
    _.assignIn(NumberFormatter.prototype, {
    ...
    PercentFormatter.prototype = new Backgrid.NumberFormatter(),
      ...
      _.assignIn(PercentFormatter.prototype, {
        ...
        /**
           ...
           string.
         */
        defaults: _.assignIn({}, NumberFormatter.prototype.defaults, {
          multiplier: 1,
          symbol: "%"
        }),
    ...
    */
    ...
    _.assignIn(DatetimeFormatter.prototype, {
    ...
    _.assignIn(StringFormatter.prototype, {
      /**
    ...
    _.assignIn(EmailFormatter.prototype, {
      /**
      ...
      toRaw: function (formattedData, model) {
        ...
        if (parts.length === 2 && _.every(parts)) {
          return formattedData;
        }
      }
    });
    ...
    */
    ...
    _.assignIn(SelectFormatter.prototype, {
    ...
    var DatetimeCell = Backgrid.DatetimeCell = Cell.extend({
      ...
      */
      initialize: function (options) {
        ...
        this.editor = this.editor.assignIn({
          attributes: _.assignIn({}, this.editor.prototype.attributes, this.editor.attributes, {
    ...
    */
    ...
    _.forEach(["sortable", "renderable", "editable"], function (key) {
    ...
    var Body = Backgrid.Body = Backbone.View.extend({
      ...
      */
      initialize: function (options) {
        ...
        this.rows = this.collection.map(_.bind(function (model) {
