    ...
    */
    ...
    return Backbone.View.extend({
        ...
        initialize: function initialize() {
            this.data = this.data || {};
            _.assignIn(this.events, this.defaultEvents);
            this.delegateEvents();
        },
        ...
        loadTemplate: function loadTemplate() {
            ...
            $.when.apply($, _.map(this.partials, UIUtils.preloadPartial)).then(function () {
                UIUtils.renderTemplate(self.template, self.$el, _.assignIn({}, Configuration.globalData, self.data), self.callback ? _.bind(self.callback, self) : _.noop(), self.mode, validateCurrent);
            });
        },
