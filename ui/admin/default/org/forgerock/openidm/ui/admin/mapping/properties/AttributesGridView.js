        ...
        */
        ...
        sampleEvalCheck: function sampleEvalCheck(sampleDetails, globals) {
            ...
            if (sampleDetails.hasCondition) {
                globals.oldTarget = conf.globalData.property ? conf.globalData.property : null;
                if (_.isString(sampleDetails.condition)) {
                    ...
                    ScriptDelegate.evalScript(sampleDetails.condition, { "linkQualifier": globals.linkQualifier, "object": sampleSource, "target": globals.target, "oldTarget": globals.oldTarget }).then(function (conditionResults) {
