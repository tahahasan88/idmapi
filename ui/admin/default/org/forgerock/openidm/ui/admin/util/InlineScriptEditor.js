    ...
    var seInstance = {},
        ...
        */
        render: function render(args, callback) {
            ...
            this.model = _.assignIn(this.model, args);
            ...
            this.parentRender(_.bind(function () {
                ...
                _.forEach(this.model.passedVariables, _.bind(function (value, key) {
        ...
        generateScript: function generateScript() {
            ...
            if (currentSelection === "none") {
                ...
                _.forEach(this.model.editors, _.bind(function (jsonEditor) {
                ...
                scriptObject.globals = _.assignIn(scriptObject.globals, this.extendedPassVariables);
