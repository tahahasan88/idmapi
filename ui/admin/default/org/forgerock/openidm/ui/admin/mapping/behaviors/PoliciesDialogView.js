        ...
        render: function render(args) {
            ...
            BootstrapDialogUtils.createModal({
                ...
                onshown: function onshown() {
                    uiUtils.renderTemplate(_this.template, _this.$el, _.assignIn({}, conf.globalData, _this.data), _.bind(function () {
                        var tempSelector,
                            actionScriptData = {},
                            workflowName,
                            conditionScriptData = {},
                        ...
                        _.forEach(this.model.basePolicy.options, _.bind(function (action) {
                        ...
                        _.forEach(this.data.mappingProperties, _.bind(function (property) {
