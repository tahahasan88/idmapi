    ...
    var IndividualRecordValidationView = MappingAdminAbstractView.extend({
        ...
        render: function render() {
            ...
            ConfigDelegate.readEntity("managed").then(function (managed) {
                _.forEach(managed.objects, _.bind(function (managedObject) {
                ...
                if (!_this.data.preferences) {
                    _this.data.preferences = {};
                }
                _this.model.allPreferences = _.keys(_this.data.preferences);
