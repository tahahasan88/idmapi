...
define(["jquery", "lodash", "form2js", "org/forgerock/openidm/ui/admin/mapping/util/MappingAdminAbstractView", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/components/ChangesPending", "org/forgerock/openidm/ui/admin/delegates/ClusterDelegate"], function ($, _, form2js, MappingAdminAbstractView, constants, eventManager, ChangesPending, ClusterDelegate) {
    var AdvancedView = MappingAdminAbstractView.extend({
        ...
        render: function render(args, callback) {
            ...
            var mapping = this.getCurrentMapping(),
                panelParams = [this.createUiObj("param", { name: "correlateEmptyTargetSet", fieldType: "boolean" }), this.createUiObj("param", { name: "prefetchLinks", fieldType: "boolean" }), this.createUiObj("param", { name: "allowEmptySourceSet", fieldType: "boolean", helpLink: "prevent-accidental-deletion.html" }), this.createUiObj("param", { name: "taskThreads", fieldType: "text", defaultValue: "10" }), this.createUiObj("param", { name: "enableSync", fieldType: "boolean", defaultValue: true })];
            ...
            this.clusterCheck().then(function (clusterEnabled) {
                ...
                _this.data.panels = [_this.createUiObj("panel", { name: "additionalOptions", mapping: mapping, helpLink: "chap-performance.html", description: true, params: panelParams })];
