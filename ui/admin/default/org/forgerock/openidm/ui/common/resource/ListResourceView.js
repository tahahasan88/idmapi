...
define(["jquery", "underscore", "handlebars", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/util/CookieHelper", "org/forgerock/commons/ui/common/util/UIUtils", "backgrid", "org/forgerock/openidm/ui/common/util/BackgridUtils", "org/forgerock/openidm/ui/common/delegates/ResourceDelegate", "org/forgerock/commons/ui/common/components/Messages", "org/forgerock/commons/ui/common/main/AbstractModel", "org/forgerock/commons/ui/common/main/AbstractCollection", "org/forgerock/openidm/ui/common/resource/ResourceCollection", "org/forgerock/openidm/ui/common/resource/util/ResourceQueryFilterEditor", "backgrid-paginator", "backgrid-selectall"], function ($, _, Handlebars, AbstractView, eventManager, conf, constants, cookieHelper, uiUtils, Backgrid, BackgridUtils, resourceDelegate, messagesManager, AbstractModel, AbstractCollection, ResourceCollection, ResourceQueryFilterEditor) {
    var ListResourceView = AbstractView.extend({
        ...
        render: function render(args, callback) {
            ...
            if (_.has(conf.globalData, "platformSettings.managedObjectsSettings." + this.data.objectName + ".minimumUIFilterLength")) {
                this.data.queryThreshold = conf.globalData.platformSettings.managedObjectsSettings[this.data.objectName].minimumUIFilterLength;
            }
        ...
        buildResourceListGrid: function buildResourceListGrid(cols, queryFilter) {
            ...
            this.model.resources.on("sync", function (collection) {
                ...
                if (_this3.data.queryThreshold) {
                    var searchForms = _this3.$el.find(".filter-header-cell form"),
                        queryThreshold = _this3.data.queryThreshold;
            ...
            editor.render({
                ...
                "onChange": function onChange() {
                    if (editor.getFilterString()) {
                        _this4.$el.find("#doAdvancedFilter").prop("disabled", false);
                        _this4.$el.find('#clearFiltersBtn').prop('disabled', false);
                    } else {
                        _this4.$el.find("#doAdvancedFilter").prop("disabled", true);
                        _this4.$el.find('#clearFiltersBtn').prop('disabled', true);
                    }
                }
            });
