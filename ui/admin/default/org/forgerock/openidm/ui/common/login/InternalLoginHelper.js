...
define(["jquery", "underscore", "org/forgerock/openidm/ui/common/UserModel", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/main/AbstractConfigurationAware", "org/forgerock/commons/ui/common/main/ServiceInvoker", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/openidm/ui/common/util/Constants"], function ($, _, UserModel, eventManager, AbstractConfigurationAware, serviceInvoker, conf, Constants) {
    ...
    obj.logout = function (successCallback) {
        ...
        // if platformSettings exists and .amUrl is defined we know we are in "platformMode"
        if (conf.globalData.platformSettings && conf.globalData.platformSettings.amUrl) {
            window.logout();
        } else {
            if (conf.loggedUser) {
