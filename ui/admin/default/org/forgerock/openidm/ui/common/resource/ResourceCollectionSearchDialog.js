...
define(["jquery", "underscore", "org/forgerock/commons/ui/common/main/AbstractView", "org/forgerock/commons/ui/common/main/Configuration", "org/forgerock/commons/ui/common/main/EventManager", "org/forgerock/commons/ui/common/util/Constants", "org/forgerock/commons/ui/common/util/UIUtils", "org/forgerock/openidm/ui/common/util/BootstrapDialogUtils", "org/forgerock/openidm/ui/common/util/ResourceCollectionUtils"], function ($, _, AbstractView, conf, eventManager, constants, uiUtils, BootstrapDialogUtils, ResourceCollectionUtils) {
    var ResourceCollectionSearchDialog = AbstractView.extend({
                    ...
                    buttons: [{
                        ...
                        action: function action(dialogRef) {
                            ...
                            if (_this.currentDialog.find("#select_" + _this.data.property.propName).val()) {
                                ...
                                _.forEach(newValueArray, function (item, index) {
        ...
        loadTemplate: function loadTemplate() {
            uiUtils.renderTemplate(this.template, this.currentDialog, _.assignIn({}, conf.globalData, this.data), _.bind(function () {
        ...
        setupResourceTypeField: function setupResourceTypeField(typePath) {
            var _this = this,
                ...
                var pathArr = path.split("/"),
                    ...
                    resourceCollection = _.find(relationshipProp.resourceCollection, { path: path });
        ...
        */
        getNewValArray: function getNewValArray(refPropsOverride) {
            ...
            if (!_.isArray(relationshipValue)) {
                ...
                valueArray.push({
                    val: _.assignIn(propVal, { "_ref": relationshipValuePath, "_refProperties": refPropsOverride || getRefProps() }),
                    text: this.currentDialog.find(".selectize-input:eq(1)").find("[data-value]").text()
                });
            } else {
                _.forEach(relationshipValue, function (val) {
